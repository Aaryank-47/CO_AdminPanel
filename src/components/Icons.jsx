...
export const StarIcon = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l2.07 6.36a1 1 0 00.95.69h6.708c.969 0 1.371 1.24.588 1.81l-5.426 3.944a1 1 0 00-.364 1.118l2.07 6.36c.3.921-.755 1.688-1.538 1.118L12 18.347l-5.46 3.94c-.783.57-1.838-.197-1.538-1.118l2.07-6.36a1 1 0 00-.364-1.118L1.282 11.79c-.783-.57-.38-1.81.588-1.81h6.708a1 1 0 00.95-.69l2.07-6.36z"
    />
  </svg>
);
