...
const Food = () => {
  ...
  // Handle image selection for new food item
  ...
  // Handle image selection for editing food item
...
//               className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm sm:text-base focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 transition-colors bg-slate-200 text-black"
//               placeholder="Enter food name"
//               required
//             />
//           </div>
...
//                 className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm sm:text-base focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 transition-colors bg-white bg-slate-200 text-black"
//                 required
//               >
//                 <option value="">Select category</option>
//                 {categories.map((category) => (
